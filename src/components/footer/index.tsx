    ...
    <footer>
      <section className="bg-primary">
        <div className="container py-4">
          <div className="md:grid md:grid-cols-3 flex flex-col justify-center  items-center space-y-2">
        ...
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-start py-10">
          <div className="mb-8 md:mb-0">
            <div className="flex items-center mb-6">
              <img src={logo} alt="tecgen Logo" className="mr-2" />
            </div>
            <div className="flex gap-3 my-5">
              ...
              <div className="">
                ...
                <p className="black-dim">(800) 8001-8588, (0600) 874 548</p>
              </div>
            </div>
            <div>
          ...
          <div className=" w-7/12 md:grid grid-cols-3 gap-4">
            <div>
              <h4 className="text-lg font-semibold mb-4">Find it Fast</h4>
      ...
      <section className="bg-[#EAEAEA] py-2">
        <div className="container flex items-center justify-between">
          <h5>
            &#169; <span className="font-bold text-black-dim">Tecgen</span> -
            All Rights Reserve
          </h5>
