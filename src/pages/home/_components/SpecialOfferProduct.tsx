...
const SpecialOfferProduct: React.FC = () => {
  return (
    <div className="border-2 border-primary text-left bg-white p-5 rounded-xl min-w-72 ">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-medium leading-6 text-[#49545A]">
          Special <br /> Offer
        </h2>
        <div className="w-16 h-16 rounded-full bg-primary flex items-center justify-center">
          <h2 className="text-white text-base font-light leading-none">
            Save
            <br /> <span className="font-bold">৳120</span>
          </h2>
        </div>
      </div>
      <div className="h-[320px]">
        <Image
          src={image1}
          alt="Special Offer"
          className="h-[90%] mx-auto block scale-95 hover:scale-105 duration-300"
        />
      ...
      <div className="product-info">
        <Link
          to={"#"}
          className="text-base font-semibold text-secondary text-center block"
        >
          Game Console Controller + USB 3.0 Cable +Game Console Remote{" "}
        </Link>
        ...
        <div className="flex items-center justify-between">
          <p className="text-[#49545A] text-sm">
