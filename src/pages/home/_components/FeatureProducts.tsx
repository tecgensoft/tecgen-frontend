import icon from "../../../assets/featuresProductIcon.png"
            ...
            <div className='container my-10 py-4 px-5 bg-white drop-shadow-md rounded-md'>
                <div>
                    <div className='flex justify-between items-center mb-3 h-10'>
                        <h1 className="text-xl py-5 font-medium text-black-dim flex items-center gap-3"><Image src={icon} alt="fc" className="w-6" /> Feature Products</h1>
                        <Button className='underline font-medium text-secondary'>See more</Button>
                    </div>
